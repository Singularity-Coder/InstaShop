...
public final class ProductViewModel extends ViewModel {
    ...
    public final LiveData<RequestStateMediator<Object, UiState, String, String>> getProductListRepository(@NonNull final String category) throws IllegalArgumentException {
        return productRepository.getProductsListFromFirestore(category);
    }

    public final LiveData<RequestStateMediator<Object, UiState, String, String>> getProductFromRepository(@NonNull final String docId) throws IllegalArgumentException {
        return productRepository.getProductInfo(docId);
    }

    public final LiveData<RequestStateMediator<Object, UiState, String, String>> addWishlistProductToFirestoreFromRepository(
